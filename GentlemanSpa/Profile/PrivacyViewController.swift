...
class PrivacyViewController: UIViewController,WKNavigationDelegate, WKUIDelegate {
    ...
    override func viewDidLoad() {
       ...
       if let url = URL(string: "http://gentlemanspa-dev.us-east-2.elasticbeanstalk.com/api/Content/GetPrivacyHtml") {
